...
namespace Client.Systems
{
    ...
    {
        private readonly EcsFilterInject<Inc<Team, Position>, Exc<AttackBlockDuration, Inactive>> _filter;
        ...
        public void Run(IEcsSystems systems)
        {
            foreach (var entity in _filter.Value)
            {
                ...
                ref var currentPos = ref _filter.Pools.Inc2.Get(entity);
                ...
                foreach (var enemyEntity in _filter.Value)
                {
                    ...
                    ref var enemyPos = ref _filter.Pools.Inc2.Get(enemyEntity);
